                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="nik" id="nik" class="form-control" placeholder="input nik" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="required">Nama Tamu</label>
                                <input type="text" name="nama" id="nama" class="form-control" placeholder="input nama tamu" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="nohp" id="nohp" class="form-control" placeholder="input nohp" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
