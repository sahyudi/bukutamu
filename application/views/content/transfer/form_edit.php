        ...
        <form id="form-data" method="POST" class="needs-validation" novalidate="">
            <div class="card card-page">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <input type="text" id="id" name="id" value="<?= $transfer->id ?>" hidden>
                        <input type="text" id="uuid" name="uuid" value="<?= $transfer->uuid ?>" hidden>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="required">Nama Pelanggan</label>
                                <input type="text" name="customer_name" id="customer_name" class="form-control" value="<?= $transfer->customer_name ?>" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="required">HP Pelanggan</label>
                                <input type="text" name="customer_phone" id="customer_phone" class="form-control" value="<?= $transfer->customer_phone ?>" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control selectpicker" data-live-search="true" style="width: 100%" id="transfer_type" name="transfer_type">
                                    <?php foreach ($transfer_type as $key => $value) { ?>
                                        <option value="<?= $value->transfer_name ?>" <?= ($transfer->transfer_type == $value->transfer_name) ? 'selected' : '' ?>><?= $value->transfer_name ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control currency" id="amount" name="amount" value="<?= numberFormat_old($transfer->amount, 0) ?>" required="">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Catatan</label>
                                <textarea class="form-control" id="description" name="description"><?= $transfer->description ?></textarea>
                            </div>
                        </div>
                    </div>
                    <h5 class="text-dark mb-0">Product</h5>
