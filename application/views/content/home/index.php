...
<section class="section">
    ...
    <div class="section-body">
        <h2 class="section-title">Selamat datang, <?= ucwords(strtolower($this->session->userdata('name'))) ?></h2>
        <p class="section-lead"><?= $this->session->userdata('jabatan'); ?></p>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="start_date" value="<?= date("Y-m-d") ?>" placeholder="">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="">Tanggal Akhir</label>
                                <input type="date" class="form-control" name="end_date" value="<?= date("Y-m-d") ?>" placeholder="">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
